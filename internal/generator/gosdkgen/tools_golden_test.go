...
// TestToolHookReachesTheGoDocuments: a hook's keys and icon edits are
// what every Go tool document carries.
func TestToolHookReachesTheGoDocuments(t *testing.T) {
