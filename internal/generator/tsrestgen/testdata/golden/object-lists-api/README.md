# @schemas/object-lists-api-api

Generated TypeScript API server for the `object-lists-api` schema. Built on
`@superschematic/http-runtime` and Hono 4.13.8.

**Do not edit manually.** Regenerate it by building the `object-lists-api` schema.
...
| --- | --- | --- | --- |
| `PUT` | `/api/drawings/{id}/outline` | `drawing.saveOutline` | none |
...
import { buildRouter, type Implementations } from '@schemas/object-lists-api-api';
