# schemas_types_fixture_nested_arrays_db

Generated Python types for the **fixture-nested-arrays-db** schema.
...
```bash
uv pip install schemas_types_fixture_nested_arrays_db
```
