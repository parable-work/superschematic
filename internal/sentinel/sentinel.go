...
func Content(name string, kind ir.SchemaKind) string {
	handle := tsutil.ToClassName(name)
	switch kind {
	case ir.SchemaKindDB, ir.SchemaKindAPI, ir.SchemaKindGeneral:
		return fmt.Sprintf(`// Code generated by psgen sentinel. DO NOT EDIT.
...
func EmitService(servicePath string, cfg *schemaconfig.SchemaConfig, reg *registry.Registry) (bool, error) {
	...
	sentinelChanged, err := writeIfChanged(path, Content(cfg.Name, cfg.Kind))
	if err != nil {
		return false, err
	}
