...
//
// The validator mirrors the behavior of psgen's generated Validate() and ValidateRequired()
...
//
// The [Registry] bridges IR scalar definitions to scalar-lib validation functions.
// [DefaultRegistry] pre-populates entries for all string-based scalars in scalar-lib
